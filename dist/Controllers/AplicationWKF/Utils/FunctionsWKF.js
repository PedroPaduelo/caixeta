...
exports.EXECUT_ACTION = exports.IF = void 0;
const FunctionDados_1 = require("./fns/FunctionDados");
const FunctionsContext_1 = require("./FunctionsContext");
const functions = {
    Dados_Insert: FunctionDados_1.Dados_Insert,
    Dados_List: FunctionDados_1.Dados_List,
    Dado_Get: FunctionDados_1.Dado_Get,
    Dados_UpData: FunctionDados_1.Dados_UpData
};
function IF(argumentos, context) {
    if (argumentos.length > 0) {
        const reultIfs = argumentos.map(item => {
            const value_1 = (0, FunctionsContext_1.get_data_dynamic)(context, item.value_1);
            const value_2 = (0, FunctionsContext_1.get_data_dynamic)(context, item.value_2);
...
exports.IF = IF;
async function EXECUT_ACTION(action_name, action_tipo, action_processo, context, flag_execut) {
    let obj_result = {
        result_fn_name: {},
        result_fn_tipo: {},
        result_fn_status: {},
...
exports.EXECUT_ACTION = EXECUT_ACTION;
